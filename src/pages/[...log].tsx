...
export default function Page() {
  ...
  const logData = api.post.getLogData.useQuery({reportCode: reportCode, fightId: fightId}, {enabled: !!reportCode});
        ...
        <div className="container flex flex-col items-center justify-center gap-12 px-4 py-16 ">
          <div className="navbar bg-base-100">
            ...
            <div className="flex-1">
              <button className="btn btn-ghost text-xl">{logData.data ? logData.data.fightData?.reportData?.report?.fights[0].name : ""}
